...
function FixTitle({
  ...
  return (
    <div className="!max-h-[108px]">
      <div
        className={`${
          isCountDown ? "" : "justify-between"
        } container flex flex-row  h-auto`}
      >
        <div
        ...
        {isCountDown && (
          <div
            className={`${
              isCountDown && "md:ml-[87px]"
            } flex flex-col h-auto justify-end items-end`}
          >
            {isCountDown && (
              <ShowTime
                days={days}
        ...
        <div className={`${isCountDown && "md:ml-[470px]"} `}>
          {onPrev && onNext ? (
